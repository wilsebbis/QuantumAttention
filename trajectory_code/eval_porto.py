...
def main(eval_args):
    ...
    torch.serialization.add_safe_globals([LMTADConfig])
    ...
    if eval_args.small_data_subset:
        ...
        for outlier_parameter in outlier_parameters:
            ...
            # dataloader = DataLoader(dataset, batch_size=16, sampler=torch.utils.data.SubsetRandomSampler(indices), collate_fn=dataset.collate)
