"""
References:
    this model is inpired by nanoGTPT repository found at this location: https://github.com/karpathy/nanoGPT/tree/master
"""
...
class LMTAD(nn.Module):
    """trajectory model based on GPT2"""
    
    def __init__(self, config: LMTADConfig):
        super().__init__()
        assert config.vocab_size is not None
        assert config.block_size is not None
        self.config:LMTADConfig = config
